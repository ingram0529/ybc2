...
// Copyright (c) 2013-2014 The ybcoin developers
...
{
    // Wait for IRC to get it first - disabled with ybcoin
...
// testnet dns seed begins with 't', all else are ybcoin dns seeds.
static const char *strDNSSeed[][2] = {
    // NOTE: Only testnet nodes are included in this build. If you are using this
    // for a real ybcoin offering, you will want to remove the "t" that
    // appears before the node name and IP
    {"ybcoin.com", "s1.ybcoin.com"},
    {"ybcoin.org", "s1.ybcoin.org"},
    {"ybcoin.org", "s2.ybcoin.org"},
    {"ybcoin.com", "s2.ybcoin.com"},
    {"ybcoin.org", "tns1.ybcoin.org"},
    {"ybcoin.com", "tns1.ybcoin.com"},
    {"ybcoin.org", "s3.ybcoin.org"},
    {"ybcoin.com", "s3.ybcoin.com"},
    {"ybcoin.org", "s4.ybcoin.org"},
    {"ybcoin.com", "s4.ybcoin.com"},
    {"ybcoin.org", "s5.ybcoin.org"},
    {"ybcoin.com", "s5.ybcoin.com"},
    {"ybcoin.org", "s6.ybcoin.org"},
    {"ybcoin.com", "s6.ybcoin.com"},
};
...
bool BindListenPort(string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, sizeof(sockaddr)) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to port %d on this computer.  ybcoin is probably already running."), ntohs(sockaddr.sin_port));
        else
